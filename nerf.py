...
if __name__ == '__main__':
    ...
    train_folder = 'archive/nerf_synthetic/drums/train'
    test_folder = 'archive/nerf_synthetic/drums/test'
    
    training_images = load_images_from_folder(train_folder)
    testing_images = load_images_from_folder(test_folder)
    
    training_dataset = torch.from_numpy(training_images).float()
    testing_dataset = torch.from_numpy(testing_images).float()
